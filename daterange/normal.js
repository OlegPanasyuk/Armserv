...
var gBegin=[2004,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gcSatBG="#99ccff";	// Цвет фона для субботы
var gcSun="black";	// Цвет шрифта для воскресенья
var gcSunBG="#99ccff";	// Цвет фона для воскресенья
