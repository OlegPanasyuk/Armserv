...
var gsSplit=".";	// Разделитель в строке даты. If set it to empty string, then giMonthMode and gbPadZero will be fixed to 0 and true.
...
var gBegin=[2006,12,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gcCalBG="#c1cdcd";	// the background color of the outer calendar panel.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Вы не можете выбрать сегодняшний день!\");return false;' onmouseover='return true;' >Сегодня : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.

var giCellWidth=18;	// Ширина ячейки календаря;
var giCellHeight=14;	// Высота ячейки календаря;
var giHeadHeight=14;	// Высота строки заголовка календаря;
var giWeekWidth=14;	// Ширина столбца с номером недели;
var giHeadTop=1;	// calendar head row top offset;
var giWeekTop=0;	// calendar week-number-column top offset;

var gcCellBG="#e5e5e5";	// Фоновый цвет ячеек. Используйте "" для прозрачности!!!
...
var gcWorkday="black";	// Цвет рабочих дней
var gcSat="black";	// Цвет шрифта для субботы
var gcSatBG="#c1cdce";	// Цвет фона для субботы
var gcSun="black";	// Цвет шрифта для воскресенья
var gcSunBG="#c1cdce";	// Цвет фона для воскресенья

var gcOtherDay="silver";	// цвет шрифта для дней в других месяцах ; Не используется, если giShowOther установлен как скрытый.
var gcOtherDayBG=gcCellBG;	// цвет фона для дней в других месяцах. Когда giShowOther установлен как скрытый, заменняется gcOtherDay.
...
var gcFGToday="red";	// цвет шрифта для сегодняшнего дня 
var gcBGToday="white";	// цвет фона для сегодняшнего дня 
var guTodayBGImg="";	// url фоновой картинки для сегодняшнего дня
