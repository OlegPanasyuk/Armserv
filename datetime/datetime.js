...
var gsOutOfRange="Дата вне пределов разрешенного диапазона!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsTodayTip="TСегодня";	// tooltip for today
