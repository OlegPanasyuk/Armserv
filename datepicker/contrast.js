...
var gsOutOfRange="Нельзя выбрать указанный день!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Нельзя выбрать указанный день!\");return false;' onmouseover='return true;' >Today</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
