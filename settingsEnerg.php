 ...
 $file = file($filename) or die("Невозможно прочитать файл настроек!");      
  ...
  {      
    ...
    {          
	  ...
	  $vis = 'display:none;';
	  if(($key=='MaxVal') or ($key =='Prec') or  ($key == 'PreMax') or ($key == 'H1') or ($key == 'H2') or ($key == 'H3') or ($key == 'H4')) {$vis=''; $cnt++;};
      echo "  <tr style=' ".$vis." font-family: verdana; font-size: 12px;background-color: #F6F9F3;'>\n"; 
