...
control+="  <tr><TD style='width:160px'>";
control+="<input type='hidden' name='tab' value='"+tab+"' size=2>";
control+="   <select name='type' size='1' style='width:160px'>";
control+="	<option value='1' SELECTED>приращение энергии</option>";
control+="	<option value='2'>накопленна€ энерги€</option>";
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:120px;'>по состо€нию на</TD></tr>";
control+=" <tr><td style='width:105px;'><input name='dc' value='' size='9' readonly style='font-weight:bolder'>";
...
control+="<img id='print' src='images/print.gif' alt='печать' style='cursor:hand' width='26' height='22' border='0' align='middle' onclick='window.print();' onmouseover='ptintimg()' onmouseout ='ptintimg2()' >";control+="&nbsp;&nbsp;<img src='images/excel24.gif' id='toXLS' alt='экспорт в Excel' style='cursor:hand' width='24' height='24' border='0' align='middle' ONCLICK='excel_exp();'>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form4'>";
control+="  </TD>";
