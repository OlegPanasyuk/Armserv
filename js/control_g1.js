...
control+="<LEGEND ALIGN='left' id='legenda'>Формат данных2</LEGEND>";
...
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:25px;'>тип</TD></tr>";
