...
control+="<TABLE BORDER='0' cellpadding='1' cellpadding='1' width='100%' id='formatData'>";
control+="<TR>";
control+="  ";
...
control+="  <tr><TD style='width:45px;'>время &nbsp;</TD></tr>";
control+=" <tr><td align='left' style='width:160px'><input name='dc' value='' size='14' readonly style='font-weight:bolder'>";
...
control+="<tr><td><input type='submit' value='чтение' id='go' onclick='checkID()' style=\"font-size:12px;font-weight:bolder;\">";
