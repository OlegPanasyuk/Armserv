...
control="<div class='help' id='subcontrol' style='width:195px; height:"+div_height+"; Text-align:center;z-index:+1'>"
//===========================================================================================================================
...
control+="<LEGEND ALIGN='left' id='legenda'>Сормат данных</LEGEND>";
...
control+="   <select name='disp' size='1' style='width:100px' onchange='powerc(this.value)'>";
control+="	<option value='1' >мощность</option>";
control+="	<option value='2' SELECTED>энергию</option>";
control+="	<option value='3'>показани¤</option>";
control+="   </select>";
control+="</TD></tr>";
...
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:130px;' id='maxp_lab'>контроль мощности</TD></tr>";
...
control+="  <tr><TD style='width:55px;'>за день</TD></tr>";
control+=" <tr><td style='width:100px;'><input name='dc' value='' size='9' readonly style='font-weight:bolder'>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form1'>";
control+="  </TD>";
...
//CloseXls();
 ...
 {
  alert("Эшибка экспорта: "+e.name);return 0;
 }
}
