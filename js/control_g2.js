...
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:20px;'>тип&nbsp;</TD></tr>";
control+="  <tr><TD style='width:160px'>";
control+="   <select name='type' size='1' style='width:150px'>";
control+="	<option value='1' SELECTED>активна€ прием</option>";
control+="	<option value='2'>активна€ отдача</option>";
control+="	<option value='3'>реактивна€ прием</option>";
control+="	<option value='4'>реактивна€ отдача</option>";
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:30px;'>зона&nbsp;</TD></tr>";
control+="  <tR><TD style='width:95px'>";
control+="   <select name='zone' size='1' style='width:90px'>";
control+="	<option value='0' SELECTED>нет</option>";
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:50px;'>за день</TD></tR>";
control+="<tr><td align='center' style='width:110px'><input name='dc' value='' size='9' readonly style='font-weight:bolder'>";
...
function optListChange(main)
{
if (main.selectedIndex==0)
{
    for (i = 0; i < options.length; i++)
	{
     document.topmenu.zone.options[i] = options[i];
	 document.topmenu.zone.options[i].value = optval[i];
	} 
}	
if (main.selectedIndex==1)
{
    for (i = options.length; i >0; i--) 
    document.topmenu.zone.options[i] = null;
