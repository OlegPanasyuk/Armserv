...
control="<div class='help' id='subcontrol' style='width:100%; height:"+div_height+"; Text-align:left;z-index:+1'>"
//===========================================================================================================================
control+="<div class='handle' href=''></div> <!-- Ссылка для пользователей с отключенным JavaScript -->"
control+="<FIELDSET ID='fld3' style='width:100%;background-color:#c1cdcd; border:2px solid $fff'>";
control+="<form name=\"topmenu\" method=\"get\">";
control+="<LEGEND ALIGN='left' id='legenda'>‘ормат данных</LEGEND>";

control+="<TABLE BORDER='0' cellpadding='1' width='100%' id='formatData'>";
control+="<TR>";
control+="  <TD style='width:110px;'>отображать как&nbsp;</TD>";
control+=" <TD style='width:120px'>";
control+="<input type='hidden' name='tab' value='"+tab+"' size=2>";
control+="   <select name='disp' size='1' style='width:120px' onchange='powerc(this.value)'>";
control+="	<option value='2' SELECTED>объем за день</option>";
control+="	<option value='3'>показания</option>";
control+="   </select>";
control+=" </TD>";
control+="  <TD style='width:140px; display:none;' id='maxp_lab'>контроль мощности&nbsp;</TD>";
control+="  <TD style='width:55px;display:none;'>";
...
control+="   </select>";
control+="</TD>";
control+="  <TD style='width:140px;'>отображать контур</TD>";
control+="  <TD style='width:50px;'>";
control+="   <select name='disp_circle' size='1' style='width:50px;'>";
control+="	<option value='1'SELECTED>#1</option>";
control+="	<option value='2'>#2</option>";
control+="	<option value='3'>#3</option>";
control+="	<option value='4'>#4</option>";
control+="   </select>";
control+="</TD>";
control+="<TD style='width:140px; display:none;' id='maxp_lab'>единицы измерения&nbsp;</TD>";
control+=" <TD style='width:105px;display:none;'>";
...
control+="   </select>";
control+="</TD>";
control+="  <TD style='width:60px;'>на день&nbsp;</TD>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form11'>";
control+="  </TD>";
