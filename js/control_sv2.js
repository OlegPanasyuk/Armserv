...
control+="<img align='absmiddle' src='images/calbtn_small.gif' width='14' height='22' border='0' alt='Календарь' onMouseOver='this.style.cursor=\"hand\"'>	</a> </td><td><input type='radio' name='kt' value='1' checked>коэфф из базы</td><td><input type='radio' name='kt' value='0'>вручную </td><td><input type='text' name='ktrr' value='1'></td></TR>";
