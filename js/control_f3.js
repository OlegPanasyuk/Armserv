...
control+="   </select>";
control+="</TD></TR>";
control+="  <TR><TD style='width:140px;' id='maxp_lab'>тип&nbsp;</TD></TR>";
control+="  <TR><TD style='width:145px'>";
control+="   <select name='type' size='1' style='width:140px'>";
control+="	<option value='1' SELECTED>активная прием</option>";
control+="	<option value='2'>активная отдача</option>";
control+="	<option value='3'>реактивная прием</option>";
control+="	<option value='4'>реактивная отдача</option>";
control+="   </select>";
control+="</TD></TR>";
