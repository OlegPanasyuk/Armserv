...
control+="   </select>";
control+="</TD></TR>";
control+="  <TR><TD style='width:140px;display:none;' id='maxp_lab'>контроль мощности&nbsp;</TD></TR>";
...
control+="   </select>";
control+="</TD></TR>";
control+="<TR><TD style='width:140px;display:none;' id='maxp_lab'>единицы измерения&nbsp;</TD></TR>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form9'>";
control+="  </TD>";
