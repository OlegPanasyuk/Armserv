...
control="<div class='help' id='subcontrol' style='width:150px; height:"+div_height+"; Text-align:center;z-index:+1'>"
//===========================================================================================================================
...
control+="<TR>";
control+="  <TD style='width:70px;'><input type='hidden' name='tab' value='"+tab+"' size=2>показания</TD>";

control+="  </tr>";
control+="  <tr><TD style='width:150px'>";
control+="   <select name='type' size='1' style='width:150px'>";
control+="	<option value='5' SELECTED>активная прием</option>";
control+="	<option value='6'>активная отдача</option>";
control+="	<option value='7'>реактивная прием</option>";
control+="	<option value='8'>реактивная отдача</option>";
control+="   </select>";
control+="</TD></tr>";
...
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:80px;'>за период с</TD></tr>";
control+=" <tr><td align='center' style='width:100px'><input name='dc1' value='' size='9' readonly style='font-weight:bolder'>";
...
control+=" <tr><td align='center' style='width:100px'><input name='dc2' value='' size='9' readonly style='font-weight:bolder'>";
...
if (window.document.topmenu.dc1.value=='') window.document.topmenu.dc1.value=curdate;
