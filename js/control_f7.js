...
var curdate2='1.'+month+'.'+year;
control="<div class='help' id='subcontrol' style='width:140px; height:"+div_height+"; Text-align:center;z-index:+1'>"
//===========================================================================================================================
...
control+="<LEGEND ALIGN='left' id='legenda'>формат данных</LEGEND>";
control+="<TABLE BORDER='0' cellpadding='1' cellpadding='1' width='99%' id='formatData'>";
control+="<TR>";
control+="<TD style='width:130px;' id='maxp_lab'>единицы измерения <input type='hidden' name='tab' value='"+tab+"' size=2></TD></tr>";
...
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:90px;'>за период с</TD></tr>";
control+=" <tr><td align='center' style='width:120px'><input name='dc1' value='' size='9' readonly style='font-weight:bolder'>";
control+="<a href='javascript:void(0)' onclick='if(self.gfPop)gfPop.fStartPop(document.topmenu.dc1,document.topmenu.dc2);return false;' HIDEFOCUS>";
control+="<img align='absmiddle' src='images/calbtn_small.gif' width='14' height='22' border='0' alt=' јЋ≈Ќƒј–№' onMouseOver='this.style.cursor=\"hand\"'>	</a> </td></tr>";

control+="  <tr><TD style='width:20px;'>по</TD></tr>";
control+=" <tr><td align='center' style='width:120px'><input name='dc2' value='' size='9' readonly style='font-weight:bolder'>";
control+="<a href='javascript:void(0)' onclick='if(self.gfPop)gfPop.fEndPop(document.topmenu.dc1,document.topmenu.dc2);return false;' HIDEFOCUS>";
control+="<img align='absmiddle' src='images/calbtn_small.gif' width='14' height='22' border='0' alt=' јЋ≈Ќƒј–№' onMouseOver='this.style.cursor=\"hand\"'>	</a> </td></tr>";
/*
...
control+="<img align='absmiddle' src='images/calbtn_small.gif' width='14' height='22' border='0' alt=' јЋ≈Ќƒј–№' onMouseOver='this.style.cursor=\"hand\"'>	</a> </td>";

*/
control+="<tr><td><input type='submit' value='чтение' onclick='checkID()' style=\"font-size:12px;font-weight:bolder;\"></td>";
control+="  <TD>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form7'>";
control+="  </TD>";
...
document.write('<iframe width=174 height=190 name="gToday:normal" id="gToday:normal" src="daterange/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-500px; top:0px;"></iframe>');
//document.write('<iframe width=132 height=142 name="gToday:contrast" id="gToday:contrast" src="daterange/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-500px; top:0px;"></iframe>');

if (window.document.topmenu.dc1.value=='') window.document.topmenu.dc1.value=curdate2;
if (window.document.topmenu.dc2.value=='') window.document.topmenu.dc2.value=curdate;
