//================================================================================================
//  for tab of united water by hours on day
var div_height=50;
var now=new Date();
...
//control+="	<option value='1' >мощность</option>";
control+="	<option value='2'SELECTED>объем за часы</option>";
control+="	<option value='3'>показания</option>";
control+="   </select>";
control+="</TD></tr>";
control+="<tr><TD style='width:130px;display:none;' id='maxp_lab'>единицы измерения</TD></tr>";
control+="  <tr><TD style='width:105px;display:none;'>";
control+="   <select name='edizm' size='1' style='width:100px'>";
control+="	<option value='1' SELECTED>кВт/квар</option>";
control+="	<option value='1000'>МВт/Мвар</option>";
control+="   </select>";
control+="</TD></tr>";
control+="  <tr><TD style='width:130px;display:none;' id='maxp_lab'>контроль мощности</TD></tr>";
control+="  <tr><TD style='width:55px;display:none;'>";
...
control+="  <tr><TD style='width:60px;'>за день&nbsp;</TD></tr>";
control+=" <tr><td style='width:110px;'><input name='dc' value='' size='9' readonly style='font-weight:bolder'>";
...
control+="<input type='hidden' name='frameName' id='frameName' value='form12'>";
control+="  </TD>";
